...
const router = createRouter({
	...
	routes: [
        ...
        { path:'/all-news', name: 'NewsPage', component: () => import('../views/AdminViews/News/NewsManagement.vue') ,meta: {  requiresAdminOrSuperAdmin: true }},
        { path:'/manage-article', name: 'ArticlePage', component: () => import('../views/AdminViews/News/NewsManagement.vue') ,meta: {  requiresAdminOrSuperAdmin: true }},
        { path:'/manage-events', name: 'EventsPage', component: () => import('../views/AdminViews/News/NewsManagement.vue') ,meta: {  requiresAdminOrSuperAdmin: true }},
        { path:'/manage-announcement', name: 'AnnouncementPage', component: () => import('../views/AdminViews/News/NewsManagement.vue') ,meta: {  requiresAdminOrSuperAdmin: true }},
        { path:'/manage-updates', name: 'UpdatesPage', component: () => import('../views/AdminViews/News/NewsManagement.vue') ,meta: {  requiresAdminOrSuperAdmin: true }},
        { path:'/manage-draft', name: 'DraftPage', component: () => import('../views/AdminViews/News/NewsManagement.vue')},
        { path:'/add-news', name: 'AddNews', component: () => import('../views/AdminViews/News/AddNews.vue') ,meta: {  requiresAdminOrSuperAdmin: true }},
        //Admin
