<template>
<nav class=" top-0 z-50 w-full bg-white border-b-2 border-orange-200 dark:bg-gray-800 dark:border-gray-700">
            ...
            <div v-if="isLoggedIn">
                ...
                <div id="dropdownAvatarName" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                    ...
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownInformdropdownAvatarNameButtonationButton">
                        <li>
                            <a href="#" class="block px-4 py-2 hover:text-orange-300 dark:hover:bg-gray-600 dark:hover:text-white">Dashboard</a>
                        </li>
                        <li>
                            <a href="#" class="block px-4 py-2 hover:text-orange-300 dark:hover:bg-gray-600 dark:hover:text-white">Settings</a>
                        </li>
                        <li>
