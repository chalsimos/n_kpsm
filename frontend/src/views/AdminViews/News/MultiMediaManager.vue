    ...
    methods: {
        initDropzone() {
            ...
            const defaultOptions = {
                url: 'http://localhost:8000/api/news-portal/upload-file',
                maxFilesize: 2,
                acceptedFiles: 'image/*',
            };
        ...
        fetchImages() {
            axios.get('http://localhost:8000/api/news-portal/images')
                .then(response => {
        ...
        fetchNews() {
            axios.get('http://localhost:8000/api/getnews')
                .then(response => {
        ...
        updateImage() {
            axios.put(`http://localhost:8000/api/news-portal/images/${this.modalImage.id}`, this.modalImage)
                .then(response => {
